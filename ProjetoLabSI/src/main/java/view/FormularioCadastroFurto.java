...
public class FormularioCadastroFurto extends JFrame {
	...
	public static void main(String[] args) {
		JOptionPane.showMessageDialog(null, "Registrar Furto");
	...
	public FormularioCadastroFurto() {
		...
		lblBoDeExtravio.setIcon(new ImageIcon("C:\\ProjetosGit\\ProjetoDelegaciaVirtual\\Imagens\\icon_bo_furto.png"));
		...
		ta_descricao.setBounds(415, 425, 339, 74);
		...
		btnRegistrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				furto.setRg(tf_rg.getText());
				furto.setEstado1((String) cb_estado1.getSelectedItem());
				furto.setSexo((String) cb_sexo.getSelectedItem());
				furto.setMae(tf_nomeMae.getText());
				furto.setPai(tf_nomePai.getText());
				furto.setEndereco(tf_endereco.getText());
				furto.setNumero(tf_numero.getText());
				furto.setComplemento(tf_complemento.getText());
				furto.setBairro(tf_bairro.getText());
				furto.setCidade(tf_cidade.getText());
				furto.setEstado((String) cb_estado.getSelectedItem());
				furto.setCep(tf_cep.getText());
				furto.setTelefoneres(tf_telres.getText());
				furto.setCelular(tf_celular.getText());
				furto.setEmail(tf_email.getText());
				furto.setDescricao(ta_descricao.getText());

				controle.salvarFurto(furto);
